...
import static com.company.gui.MainWindow.rightPanel;
...
//            LeftPanel.pdPanel.getPeselTextField.setText(pTable.getModel().getValueAt(pTable.getSelectedRow(), 2).toString());
            LeftPanel.pdPanel.getPeselTextField.setText(pTable.getModel().getValueAt(pTable.getSelectedRow(), 2).toString());
            if (pTable.getModel().getValueAt(pTable.getSelectedRow(), 1).toString().equals(PatientRecord.Sex.M.getSex())){
                LeftPanel.pdPanel.getManRadioButton.setSelected(true);
                LeftPanel.pdPanel.getWomanRadioButton.setSelected(false);
            }
            else if (pTable.getModel().getValueAt(pTable.getSelectedRow(), 1).toString().equals(PatientRecord.Sex.K.getSex())){
                LeftPanel.pdPanel.getManRadioButton.setSelected(false);
                LeftPanel.pdPanel.getWomanRadioButton.setSelected(true);
            }
            if (pTable.getModel().getValueAt(pTable.getSelectedRow(),3).toString().equals(PatientRecord.Insurance.NO_ANS.getIns()))
                LeftPanel.pdPanel.iComboBox.setSelectedIndex(0);
            else if (pTable.getModel().getValueAt(pTable.getSelectedRow(),3).toString().equals(PatientRecord.Insurance.NFZ.getIns()))
                LeftPanel.pdPanel.iComboBox.setSelectedIndex(1);
            else if (pTable.getModel().getValueAt(pTable.getSelectedRow(),3).toString().equals(PatientRecord.Insurance.LACK.getIns()))
                LeftPanel.pdPanel.iComboBox.setSelectedIndex(2);
            else if (pTable.getModel().getValueAt(pTable.getSelectedRow(),3).toString().equals(PatientRecord.Insurance.PRIVATE.getIns()))
    ...
    public void actionPerformed(ActionEvent e) {
            ...
            {
                PatientRecord.Sex sex;
                if (LeftPanel.pdPanel.getManRadioButton.isSelected())
                    sex = PatientRecord.Sex.M;
                else
                    sex = PatientRecord.Sex.K;

                PatientRecord.Insurance ins;
                if (LeftPanel.pdPanel.iComboBox.getSelectedIndex()==1)
                    ins =  PatientRecord.Insurance.LACK;
                else if (LeftPanel.pdPanel.iComboBox.getSelectedIndex()==2)
                    ins =  PatientRecord.Insurance.NFZ;
                else if (LeftPanel.pdPanel.iComboBox.getSelectedIndex()==3)
                    ins =  PatientRecord.Insurance.PRIVATE;
                else
                    ins =  PatientRecord.Insurance.NO_ANS;
